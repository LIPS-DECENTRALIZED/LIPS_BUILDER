    ...
    render(){
        ...
        <div id="lips" opacity="1" >
            ...
            <div id="lips_menu">
                ...
                <div><a className="lips_menu_link lips_dir_button float_left" href="https://docs.google.com/spreadsheets/d/14qZ6a_QVbq92lMGlZLp_qqwK-lCF6xYEKQ985dIysUI/edit?usp=sharing" target="_blank">DIRECTORY<br></br><img className="lips_dir_icon" src="./lips_mini.png"/></a></div>
